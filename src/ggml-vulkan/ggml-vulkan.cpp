...
static void ggml_vk_instance_init() {
    ...
    const bool layer_settings_available = ggml_vk_instance_layer_settings_available();
    // VK_EXT_layer_settings and vk::LayerSettingEXT require Vulkan headers >= 1.3.2 (e.g. VK_HEADER_VERSION 269+)
#if defined(VK_HEADER_VERSION) && VK_HEADER_VERSION >= 269
    const bool layer_settings = layer_settings_available;
#else
